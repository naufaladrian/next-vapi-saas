...
const Profile = async () => {
  ...
  const sessionHsitory = await getUserSessions(user.id);
    ...
    <main className="min-lg:w-3/4">
        ...
        <div className="flex gap-4">
            <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
                <div className="flex gap-2 items-center">
                    ...
                    <p className="text-2xl font-bold">{sessionHsitory.length}</p>
                </div>
                <div>
                    Lessons Completed
                </div>
      ...
      <Accordion type="multiple" >
        <AccordionItem value="recent">
          ...
          <AccordionContent>
            <CompanionList title="Recent Sessions" companions={sessionHsitory}/>
          </AccordionContent>
        </AccordionItem>
